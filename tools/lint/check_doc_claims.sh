...
selfcheck() {
...

    {
        ...
        echo "<!-- claim: symbol-present p2p_node_begin_message config/src/boot_zcode_swarm.c -->"
        echo "No placeholder symbol survives there."
        echo "<!-- claim: symbol-absent zzz_doc_claims_selftest_absent_zzz config/src/boot_zcode_swarm.c -->"
    ...
    } > "$tmp/good.md"
    {
        ...
        echo "<!-- claim: symbol-absent p2p_node_begin_message config/src/boot_zcode_swarm.c -->"
        echo "Stale: says an absent symbol is present."
        echo "<!-- claim: symbol-present zzz_doc_claims_selftest_absent_zzz config/src/boot_zcode_swarm.c -->"
