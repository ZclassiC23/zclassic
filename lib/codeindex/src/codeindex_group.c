...
const char *ci_group_purpose(const char *group)
{
    ...
    if (strcmp(group, "lib/metaverse") == 0) return "metaverse property rights: property identity, the pure grant/delegation rule evaluator, signed hash-chained receipts";
