 ...
 *   - block validation (lib/validation/src/check_block.c): THIS registry
 ...
 * lib/crypto/src/equihash.c is the shared, deliberately-unsealed crypto
                                           ...
                                           size_t proof_len)
{
    ...
    if (pi_len == BLOCK_HEADER_SIZE) {
         ...
         * match block_header_equihash_input() in lib/validation/src/
