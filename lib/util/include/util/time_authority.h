 ...
 * lib/util/timedata.h's network-adjusted clock, which this module does not
 ...
 * EXISTING supervised tick (lib/health/src/heartbeat.c's sweeper thread —
 ...
 *
 * This module FEEDS app/conditions/src/clock_skew_reconcile.c (which
 ...
 * Wired into lib/health/src/heartbeat.c's sweeper loop (zcl_health_sweep,
 ...
 * app/conditions/src/clock_skew_reconcile.c can consume step events as an
