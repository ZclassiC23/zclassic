 ...
 *      (config/src/boot.c:sr_confine_enter's unconfined-but-loud degrade).
 ...
 * than no diagnostic.
 *
 * Lives in lib/platform (next to the subsystem it witnesses) rather than in
 * app/controllers/src/diagnostics_registry.c, which is at its E1 file-size
