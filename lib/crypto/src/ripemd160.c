...
static inline uint32_t rmd_f1(uint32_t x, uint32_t y, uint32_t z) { return x ^ y ^ z; }
static inline uint32_t rmd_f2(uint32_t x, uint32_t y, uint32_t z) { return (x & y) | (~x & z); }
static inline uint32_t rmd_f3(uint32_t x, uint32_t y, uint32_t z) { return (x | ~y) ^ z; }
static inline uint32_t rmd_f4(uint32_t x, uint32_t y, uint32_t z) { return (x & z) | (y & ~z); }
static inline uint32_t rmd_f5(uint32_t x, uint32_t y, uint32_t z) { return x ^ (y | ~z); }

static inline uint32_t rol(uint32_t x, int i) { return (x << i) | (x >> (32 - i)); }

static inline void rmd_round(uint32_t *a, uint32_t b, uint32_t *c, uint32_t d,
...
static inline void R11(uint32_t *a, uint32_t b, uint32_t *c, uint32_t d, uint32_t e, uint32_t x, int r) { rmd_round(a, b, c, d, e, rmd_f1(b, *c, d), x, 0, r); }
static inline void R21(uint32_t *a, uint32_t b, uint32_t *c, uint32_t d, uint32_t e, uint32_t x, int r) { rmd_round(a, b, c, d, e, rmd_f2(b, *c, d), x, 0x5A827999ul, r); }
static inline void R31(uint32_t *a, uint32_t b, uint32_t *c, uint32_t d, uint32_t e, uint32_t x, int r) { rmd_round(a, b, c, d, e, rmd_f3(b, *c, d), x, 0x6ED9EBA1ul, r); }
static inline void R41(uint32_t *a, uint32_t b, uint32_t *c, uint32_t d, uint32_t e, uint32_t x, int r) { rmd_round(a, b, c, d, e, rmd_f4(b, *c, d), x, 0x8F1BBCDCul, r); }
static inline void R51(uint32_t *a, uint32_t b, uint32_t *c, uint32_t d, uint32_t e, uint32_t x, int r) { rmd_round(a, b, c, d, e, rmd_f5(b, *c, d), x, 0xA953FD4Eul, r); }

static inline void R12(uint32_t *a, uint32_t b, uint32_t *c, uint32_t d, uint32_t e, uint32_t x, int r) { rmd_round(a, b, c, d, e, rmd_f5(b, *c, d), x, 0x50A28BE6ul, r); }
static inline void R22(uint32_t *a, uint32_t b, uint32_t *c, uint32_t d, uint32_t e, uint32_t x, int r) { rmd_round(a, b, c, d, e, rmd_f4(b, *c, d), x, 0x5C4DD124ul, r); }
static inline void R32(uint32_t *a, uint32_t b, uint32_t *c, uint32_t d, uint32_t e, uint32_t x, int r) { rmd_round(a, b, c, d, e, rmd_f3(b, *c, d), x, 0x6D703EF3ul, r); }
static inline void R42(uint32_t *a, uint32_t b, uint32_t *c, uint32_t d, uint32_t e, uint32_t x, int r) { rmd_round(a, b, c, d, e, rmd_f2(b, *c, d), x, 0x7A6D76E9ul, r); }
static inline void R52(uint32_t *a, uint32_t b, uint32_t *c, uint32_t d, uint32_t e, uint32_t x, int r) { rmd_round(a, b, c, d, e, rmd_f1(b, *c, d), x, 0, r); }
...
void ripemd160_write(struct ripemd160_ctx *ctx, const unsigned char *data, size_t len)
{
    ...
    if (bufsize && bufsize + len >= 64) {
        ...
        data += 64 - bufsize;
        ripemd160_transform(ctx->s, ctx->buf);
        bufsize = 0;
    }
    while (end >= data + 64) {
        ripemd160_transform(ctx->s, data);
        ctx->bytes += 64;
        data += 64;
    }
    if (end > data) {
...
void ripemd160_finalize(struct ripemd160_ctx *ctx, unsigned char hash[RIPEMD160_OUTPUT_SIZE])
{
    ...
    WriteLE64(sizedesc, ctx->bytes << 3);
    ripemd160_write(ctx, pad, 1 + ((119 - (ctx->bytes % 64)) % 64));
    ripemd160_write(ctx, sizedesc, 8);
    WriteLE32(hash, ctx->s[0]);
    WriteLE32(hash + 4, ctx->s[1]);
    WriteLE32(hash + 8, ctx->s[2]);
