 ...
 * `<name>_dump_state_json()` in app/controllers/include/controllers/
 ...
 * simulator (lib/sim/include/sim/simnet_cluster.h): each node owns its own
 ...
 * inspection, the lib/json library the diagnostics registry itself uses to
 * serialize, and the single canonical hex codec (lib/base/include/base/
