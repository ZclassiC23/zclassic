...
static const char *const k_tier_names[VCS_POLICY_TIER_COUNT] = {
    "new-user",
    "earned-contributor",
    "verified-seeder",
};
...
static const char *const k_no_credit_names[VCS_POLICY_NO_CREDIT_COUNT] = {
    "announcement-bytes",
    "unverified-bytes",
...
static const char *const k_offence_names[VCS_POLICY_OFFENCE_COUNT] = {
    "duplicate-request",
    "unrequested-bytes",
    "invalid-chunk",
    "announce-flood",
