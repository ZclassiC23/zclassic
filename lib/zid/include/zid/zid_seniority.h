 ...
 * ADDRMAN_REPUTATION_MAX_MULT (lib/net/include/net/addrman.h): lib/zid sits
 * BELOW lib/net in config/lib_module_order.def, so lib/zid may not
 * reference lib/net. The two are pinned equal by a static assertion in
 * lib/test/src/test_zid_seniority.c, which is above both and can include
 ...
 * identity projection (app/models/include/models/zid_identity.h supplies
