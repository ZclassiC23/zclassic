 ...
 * DEFAULT OFF (config/src/boot.c:sr_sandbox_enter / sr_confine_enter):
 *
 * (1) The `confinement` witness (lib/platform/src/os_sandbox_witness.c) is
 ...
 *     hot-swap module lives under /tmp or <src>/build/hotswap (lib/hotswap/
