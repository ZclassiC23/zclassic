 ...
 *
 * Part 4 settles a separate question: app/controllers/src/blog_controller.c
 ...
 *
 * Copied verbatim from lib/znam/src/znam.c and lib/zslp/src/slp.c at the
...
/* The private fork that lived in app/controllers/src/blog_controller.c: a copy
