...
/* config/src/consensus_state_replay_receipt.c */
...
/* config/src/consensus_state_snapshot_candidate.c — the ENCODER of the
...
/* config/src/consensus_state_snapshot_candidate_validate.c — the DECODER
...
/* lib/storage/src/snapshot_shielded.c */
...
/* lib/util/src/png_writer.c — the one BIG-endian pair in the migration. */
...
/* lib/zid/src/zdesc.c — copy one of three inside lib/zid. */
...
/* lib/zid/src/zendp.c — copy two of three inside lib/zid, and the only one
...
/* lib/zid/src/zid.c — copy three of three inside lib/zid. */
...
int test_byte_order_codec(void)
{
    ...
    TEST("lib/zid: all three private copies agreed with each other and "
