 ...
 * controllers, services, lib/vcs and tools/, because the only thing
 ...
 * source lists (see BUILD_NODE_TOOL and the `-Ilib/base/include` rules in
 ...
 * encoder or decoder outside lib/base fails `make lint`.
 */
