 ...
 *   (app/services/src/snapshot_offer.c): peer_id = SHA3-256(peer_ip) over
 *   the 16-byte address, then fast_sync_solve_pow() (lib/net/src/fast_sync.c)
 ...
 *   `node->addr.svc.addr.ip` at the CALL SITE in lib/net/src/msgprocessor_snapshot.c,
 ...
 *
 *   lib/test/src/test_snapshot_serve_loopback.c reproduces the collision:
