 ...
 * controller (app/controllers/src/zcode_site_controller.c) owns routing and
 * every projection read; these functions take the already-read projection
 * rows (the SAME lib/vcs projections the zcode.* typed commands render)
 ...
 * a 200 OK download: application/octet-stream + Content-Disposition:
