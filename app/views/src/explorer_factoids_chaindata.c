 ...
 * Analysis, Checkpoint History, Block Time Analysis, and Transaction
 * Archaeology. Empty Blocks lives in explorer_factoids_empty_blocks.c;
 * Difficulty History lives in explorer_factoids_difficulty.c; Data Integrity
 * lives in explorer_factoids_integrity.c. The structure sections (1-7) live in
