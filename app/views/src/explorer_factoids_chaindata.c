 ...
 *
 * Explorer factoids VIEW — activity and archaeology sections (8-15).
 *
 ...
 * Analysis, Checkpoint History, Block Time Analysis, Transaction Archaeology,
 * and Empty Blocks. Difficulty History lives in explorer_factoids_difficulty.c;
 * Data Integrity lives in explorer_factoids_integrity.c. The structure
 * sections (1-7) live in explorer_factoids_history.c; the public entry points
 * and JSON API live in explorer_factoids_view.c. Shared SHA3/format/block
 * helpers come from views/explorer_factoids_internal.h. */
