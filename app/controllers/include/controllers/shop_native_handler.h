 ...
 *   - persistent onion identity   lib/net/src/tor_integration.c (slice A)
 ...
 * normalized), creating <datadir>/directory. lib/net's register_self()
...
/* Registry handlers, bound in config/commands/store.def. */
