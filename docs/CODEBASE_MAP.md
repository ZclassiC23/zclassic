...
|---|---|
| the 147 dumpstate subsystems | `zclassic23 statecatalog` — name, owner file, accepted key forms, owning test. **Not** `ops state` with no `--subsystem`: that errors `MISSING_SUBSYSTEM`. |
