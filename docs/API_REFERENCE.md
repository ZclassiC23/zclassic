...
| Command | Avail | Policy | Input keys (**required**) | Output schema | Example | Summary |
|---|---|---|---|---|---|---|
| `zcode package dev publish plan` (aliases: `zcode.publish.plan`) | ready | read / read / operator · foreground/moderate | **`workspace`**, **`datadir`**, **`source_root`**, **`publisher_pubkey`**, **`name`**, **`semver`**, **`license`**, `reward_address`, `znam`, `task_root`, `lane_receipt_root`, `publisher_sequence`, `parent_release_root`, `package_mapping_root`, `publication_job_root` | `zcl.zcode_publish_plan.v1` | `zclassic23 zcode publish plan --input='{"workspace":"/src/project","datadir":"/tmp/zcode-dev","source_root":"<64hex>","publisher_pubkey":"<66hex>","name":"publisher/package","semver":"1.0.0","license":"MIT"}'` | Prepare an accepted lane for offline release signing |
| `zcode package dev publish commit` (aliases: `zcode.publish`) | ready | mutate / app-write / operator · foreground/moderate | **`workspace`**, **`datadir`**, **`source_root`**, **`release_hex`**, `task_root`, `lane_receipt_root`, `day`, `package_mapping_root`, `publication_job_root` | `zcl.zcode_publish_commit.v1` | `zclassic23 zcode publish --input='{"workspace":"/src/project","datadir":"/tmp/zcode-dev","source_root":"<64hex>","release_hex":"<hex>"}'` | Publish one offline-signed accepted-lane release |
