...
| `app presentation development` | ready | mutate / app-write / operator, display-only · fast/low | `workspace`, `output`, `page` | `zcl.app_presentation_development.v1` | `zclassic23 app presentation development` | Show the latest exact local development consequence in native C23 |
