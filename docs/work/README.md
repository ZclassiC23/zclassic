...
| [`ZC23_LIVING_COMMONS.md`](./ZC23_LIVING_COMMONS.md) | PLAN | immutable pre-genesis ZC23 naming, creation-backed issuance covenant, exact supply arithmetic, patronage boundary, and LC0-LC5 safe implementation order |
