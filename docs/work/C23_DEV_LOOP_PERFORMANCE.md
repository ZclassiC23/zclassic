...
- Bring the remaining broad plans under the resident proof bound without
  ...
  instrumentation remains open. The latest integrated full replay is complete
  at p50 5.399 s / p95 7.186 s and 10/61 (16.39%) under five seconds; the two
  broad plans (11 occurrences) still refuse before proof compilation/linking.
