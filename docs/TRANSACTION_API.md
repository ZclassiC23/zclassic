...
| Identity/directory | `zid_anchor`, `zid_rotate`, `zid_revoke`, `zdir_register`, `zdir_deregister` | Explicit OP_RETURN compose/broadcast paths; both exact ZDIR command shapes have isolated owner-funded mined-and-projected proofs. |
...
The current complete inventory is **34/34 isolated cases passing**, with **26
