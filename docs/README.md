...
- [`TWO_LAPTOP_MARKET_TEST.md`](./TWO_LAPTOP_MARKET_TEST.md) — operator runbook:
  two real machines rendezvous over Tor, seller announces a paid offer, buyer
  pays and retrieves; includes the current IP-exposure limitation on chunk
  delivery.
