...
HARD RULES: consensus parity inviolable; every malloc via zcl_malloc, every error return LOG_*, files < 800 lines; recovery-apply / cutover paths stay CONTAINED and owner-gated (respect check-no-new-borrowed-seed / check-no-new-repair-rung); NEVER touch ~/.zclassic-c23 (live canonical), ~/.zclassic-c23-mint (producer), or stop zclassicd. If your worktree cannot link, FIRST: cp -a /home/rhett/github/zclassic23/vendor/lib vendor/. You are in your OWN isolated git worktree — commit to THIS branch only; do NOT push/merge/touch others. Self-gate per lane. Final message = structured data, technical; report the branch name.`
