...
HARD RULES: consensus parity inviolable; recovery/cutover paths CONTAINED + owner-gated (respect check-no-new-borrowed-seed / check-no-new-repair-rung); every malloc via zcl_malloc, every error return LOG_*, files < 800 lines; NEVER touch ~/.zclassic-c23, ~/.zclassic-c23-mint, or stop zclassicd. If your worktree cannot link, run make worktree-init first. OWN isolated worktree — commit to THIS branch only, do NOT push/merge/touch others. Self-gate per lane. Final message = structured data, technical; report the branch name.`
