...
HARD RULES: consensus parity inviolable — do NOT change tx validity or the C23-native Groth16 prover (out of scope; the wallet ships on librustzcash). NEVER touch a live datadir (~/.zclassic-c23), the mint producer (~/.zclassic-c23-mint), or stop zclassicd. every malloc via zcl_malloc, every error return LOG_*, files < 800 lines. If your worktree cannot link, FIRST: cp -a /home/rhett/github/zclassic23/vendor/lib vendor/. You are in your OWN isolated git worktree — commit to THIS branch only; do NOT push/merge/touch others. Self-gate: make build-only + make t-fast ONLY=<your-group> + make lint. Final message = structured data, technical; report the branch name + found_defect.`
