 ...
 *
 * config/ wires the process together and therefore sits ABOVE lib/. lib/net
 ...
 * mutually dependent. lib/net now declares what it needs; this file supplies
 * it. Nothing here is new policy — each adapter forwards to the function
 * lib/net previously called directly.
 *
 ...
 * lib/net WITHOUT config/ leaves the port unset, and it fails closed.
 */
